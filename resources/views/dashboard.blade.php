        ...
        <div class="col-md-3">
          <div class="card card-chart">
            ...
            <div class="dashboard-card-body">
              <p class="card-title">Total Projects.<span class="badge badge-lg header-danger">+ {{$dashboard ?  $dashboard['projectsTotal']:'0'}}</span></p></br>		  		  
            </div>
            <div class="card-footer">
              <div class="stats">
                <i class="material-icons">Last Updated: </i><span class="tr-danger">  {{$dashboard ?  $dashboard['projectsUpdate']:'0 weeks ago'}}</span>
              </div>
            </div>			
          </div>
        </div>	  
