      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">	
            ...
            <a class="dropdown-item not2" href="{{ url('notifications/2') }}"><i class="fa fa-envelope-open text-default"></i></a>
            <a class="dropdown-item not3" href="{{ url('notifications/3') }}"><i class="fa fa-envelope-open text-default"></i></a>
            <a class="dropdown-item not4" href="{{ url('notifications/4') }}"><i class="fa fa-envelope-open text-default"></i></a>			
          </div>
        </li>
